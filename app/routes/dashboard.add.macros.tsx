            ...
            >
                <div className="flex flex-col center gap-y-12">
                    ...
                    <div className="flex flex-col justify-start">
                        ...
                        />
                        <Error
                            message={addMacros?.data?.fieldErrors?.calories}
                        />
                    </div>
                    ...
                    <div className="flex items-start gap-x-4">
                        <div className="flex flex-col justify-start">
                            ...
                            />
                            <Error
                                message={addMacros?.data?.fieldErrors?.proteins}
                            />
                        </div>
                        ...
                        <div className="flex flex-col justify-start">
                            ...
                            />
                            <Error
                                message={addMacros?.data?.fieldErrors?.carbs}
                            />
                        </div>
                        ...
                        <div className="flex flex-col justify-start">
                            ...
                            />
                            <Error
                                message={addMacros?.data?.fieldErrors?.fat}
                            />
                        </div>
                        ...
                        <div className="flex flex-col justify-start">
                            ...
                            />
                            <Error
                                message={addMacros?.data?.fieldErrors?.water}
                            />
                        </div>
                    </div>
